<script lang="ts">
  ...
  onMount(() => {
    ...
    const LAYERS = [
      { count: 0.55, r: [0.5, 0.9], v: [8, 20], a: [0.25, 0.5] },
      { count: 0.32, r: [0.8, 1.4], v: [24, 44], a: [0.4, 0.7] },
      { count: 0.13, r: [1.3, 2.2], v: [52, 80], a: [0.65, 1] },
    ];
    ...
    function build() {
      ...
      const total = Math.round(2080 * density * Math.max(0.35, area));
      stars = [];
